...
export const rentalUnits: RentalUnit[] = [
  { id: "hytte-1", accommodationId: "sea-cabin", name: "Hytte 1", active: true },
  { id: "hytte-2", accommodationId: "sea-cabin", name: "Hytte 2", active: true },
  { id: "hytte-3", accommodationId: "sea-cabin", name: "Hytte 3", active: true },
  { id: "hytte-4", accommodationId: "sea-cabin", name: "Hytte 4", active: true },
  { id: "hytte-5", accommodationId: "basecamp-room", name: "Hytte 5", active: true },
  { id: "hytte-6", accommodationId: "basecamp-room", name: "Hytte 6", active: true },
  { id: "hytte-7", accommodationId: "basecamp-room", name: "Hytte 7", active: true },
];

export const bookingAddons: BookingAddon[] = [
  {
    id: "barnestol",
    name: { nb: "Barnestol", en: "High chair", de: "Kinderstuhl" },
    priceNok: 150,
    priceType: "per_stay",
    active: true,
    sortOrder: 1,
  ...
  {
    id: "sengetoy",
    name: { nb: "Sengetøy", en: "Bed linen", de: "Bettwäsche" },
    priceNok: 190,
  ...
  {
    id: "baat-med-motor",
    name: { nb: "Båt med motor", en: "Boat with engine", de: "Boot mit Motor" },
    priceNok: 450,
    priceType: "per_night",
    active: true,
    sortOrder: 3,
  ...
  {
    id: "sluttrenhold",
    name: { nb: "Sluttrenhold", en: "Final cleaning", de: "Endreinigung" },
    priceNok: 800,
    priceType: "per_stay",
    active: true,
    sortOrder: 4,
  ...
  {
    id: "tidlig-innsjekk",
    name: { nb: "Tidlig innsjekk", en: "Early check-in", de: "Früher Check-in" },
    priceNok: 300,
    priceType: "per_stay",
    active: true,
    sortOrder: 5,
...
export const bookings: Booking[] = [
  {
    ...
    productTitle: "Hytte type 1 med båt",
    rentalUnitId: "hytte-2",
    rentalUnitName: "Hytte 2",
    ...
    totalAmount: 9876,
    addons: [
      { id: "sengetoy", name: "Sengetøy", priceNok: 190, priceType: "per_person", amount: 760 },
      { id: "baat-med-motor", name: "Båt med motor", priceNok: 450, priceType: "per_night", amount: 1800 },
      { id: "sluttrenhold", name: "Sluttrenhold", priceNok: 800, priceType: "per_stay", amount: 800 },
    ],
    source: "website",
    language: "nb",
  },
  ...
  },
  {
    ...
    productTitle: "Hytte type 2 for familier",
    rentalUnitId: "hytte-6",
    rentalUnitName: "Hytte 6",
    ...
    totalAmount: 2360,
    addons: [
      { id: "sengetoy", name: "Sengetøy", priceNok: 190, priceType: "per_person", amount: 380 },
    ],
    source: "website",
    language: "en",
  },
